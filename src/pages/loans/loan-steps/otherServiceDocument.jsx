...
export default function OtherServicesDocument(props) {
    ...
    <Form name="form5" layout="vertical" requiredMark={true}>
      ...
      <div>
        <p className="custom-lbl-style">
          Bank Statement highlighting sales receipts{" "}
        </p>
      ...
      <div style={{ marginTop: 20 }}>
        <p className="custom-lbl-style">
          Annual Tax filled (or) Sales Receipts for the last 3 months{" "}
        </p>
        <Upload customRequest={handleAction}>
          <Button>Upload</Button>
        </Upload>
      ...
      <div style={{ marginTop: 20 }}>
        <p className="custom-lbl-style">
          Goods Purchased Proforma Invoice for bulk qty of last 2 months
        </p>
        <Upload customRequest={handleAction}>
          <Button>Upload</Button>
        </Upload>
